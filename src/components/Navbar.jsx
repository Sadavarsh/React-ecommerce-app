...
return (
   <>
      <header className={
        !navState ? 'absolute top-0 h-[10vh] flex items-center justify-center left-0 right-0 opacity-100 z-50 bg-black' : 'fixed top-0 left-0 right-0 h-[10vh] flex items-center justify-center opacity-100 z-[200] blur-effect-theme'
      }>
        <nav className='flex items-center justify-between nike-container relative'>
